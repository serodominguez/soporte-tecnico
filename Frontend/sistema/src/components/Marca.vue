...
export default {
  data() {
    return {
      ...
      tipos: ["EQUIPOS", "ACCESORIOS"],
      paginas: "Marcas por Página",
      search: "",
      editedIndex: -1,
      id: "",
      marca: "",
  ...
  methods: {
    ...
    listar() {
      ...
      axios
        .get("api/Marcas/Listar", configuracion)
    ...
    activardesactivarMostrar(accion, item) {
      (this.adModal = 1), (this.adMarca = item.marca);
      this.adId = item.idMarca;
      if (accion == 1) {
        this.adAccion = 1;
      } else if (accion == 2) {
        this.adAccion = 2;
    ...
    activar() {
      ...
      let configuracion = { headers: header };
      axios
        .put("api/Marcas/Activar/" + this.adId, {}, configuracion)
        .then(function (response) {
          me.adModal = 0;
          me.adAccion = 0;
          me.adMarca = "";
    ...
    desactivar() {
      ...
      let configuracion = { headers: header };
      axios
        .put("api/Marcas/Desactivar/" + this.adId, {}, configuracion)
        .then(function (response) {
          me.adModal = 0;
          me.adAccion = 0;
          me.adMarca = "";
