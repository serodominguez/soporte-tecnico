...
export default {
  data() {
    return {
      ...
      rules: {
        ...
        contador: (value) => value.length <= 20 || "Máximo 20 caracteres",
      },
    };
  },
  computed: {
  ...
  methods: {
          ...
          axios
            ...
            .catch((err) => {
              if (err.response.status == 400) {
                this.error = "La categoría ya se encuentra registrada!";
              }
            });
        } else {
          let me = this;
    ...
    activardesactivarMostrar(accion, item) {
      (this.adModal = 1), (this.adCategoria = item.categoria);
