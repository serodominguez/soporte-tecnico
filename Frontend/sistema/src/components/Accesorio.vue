...
export default {
  ...
  computed: {
    formTitle() {
      return this.editedIndex === -1 ? "Nuevo accesorio" : "Actualizar accesorio";
    },
  },
  ...
  methods: {
    ...
    listar() {
      ...
      axios
        .get("api/Equipos/ListarB", configuracion)
    ...
    seleccionarCategoria() {
      ...
      var categoriasArray = [];
      axios
        .get("api/Categorias/SeleccionarAccesorios", configuracion)
        .then(function (response) {
